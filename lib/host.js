 ...
 *
 * Publishes the seven `ghp:*` standard commands and the `manage_plugin` std
...
const facet = defineFacet(
  ...
  async function snapshot() {
    return {
      state: 'active',
      message: 'dsh-github-installer: 标准命令 ghp:* + 工具 manage_plugin（dsh-std Community v0.15）；安装器三态识别 cordis bundle / STD 标准组件(dsh-plugin.json) / 普通依赖',
      extensions: [
